...
```mermaid
mindmap
  root((Cloud, Platform & Enterprise Architecture))
...
```mermaid
flowchart LR
    A[Engineer Request] --> B[Self-Service Portal / Workflow]
    B --> C[Approved Platform Pattern]
    C --> D[Terraform / Bicep Modules]
    D --> E[CI/CD Validation]
    E --> F[Azure Deployment]
    F --> G[Monitoring, Governance and Cost Visibility]
    G --> H[Feedback into Enterprise Standards]
```
...
```mermaid
flowchart LR
    A[Business Problem] --> B[Enterprise Context]
    B --> C[Architecture Decision]
    C --> D[Platform Pattern]
    D --> E[Automation]
    E --> F[Governance]
    F --> G[Cost Visibility]
...
![Elijah's GitHub stats](https://github-readme-stats.vercel.app/api?username=mafiaboy1994&show_icons=true&theme=github_dark&hide_border=true)

![Top languages](https://github-readme-stats.vercel.app/api/top-langs/?username=mafiaboy1994&layout=compact&theme=github_dark&hide_border=true)
...
<p align="left">
  <a href="https://github.com/mafiaboy1994">
    <img src="https://img.shields.io/badge/GitHub-mafiaboy1994-181717?style=for-the-badge&logo=github" />
  </a>
</p>
